  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col items-start w-full max-xl:padding-x pt-28">
        ...
        <p className="f font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm">
        ...
        <div className="flex justify-start items-start flex-wrap w-full mt-20 gap-16">
          {statistics.map((stat) => (
            <div key={stat.label}>
              ...
              <p className="l leading-7 font-montserrat text-slate-gray">{stat.label}</p>
            </div>
          ))}
        </div>
      </div>
